...
-- Inserting a user with the role 'Librarian'
-- Insert a librarian user with encrypted password
INSERT INTO library_users (username, password, role, is_account_non_expired, is_account_non_locked, is_credentials_non_expired, is_enabled)
VALUES ('librarian', '$2a$10$U1wEFN0ntx5De75sGZ8t3uxZ2pDZZeknePzkWHePgl58EddytECp6', 'ROLE_LIBRARIAN', true, true, true, true);
